...
//
//    // Helper method to convert string to SQL Date
...
//        String dateInput = "15/09/2024";
//        String expectedOutput = "2024-09-15";
//        String actualOutput = Data.convertiFormatoData(dateInput);
//        assertEquals(expectedOutput, actualOutput, "Date format conversion should be correct.");
//    }
//
//    @Test
//    public void testConvertiFormatoData2() {
//        String dateInput = "2024-09-15";
//        String expectedOutput = "15/09/2024";
//        String actualOutput = Data.convertiFormatoData2(dateInput);
//        assertEquals(expectedOutput, actualOutput, "Date format conversion should be correct.");
//    }*/
//    
//    @Test
...
//        Date validDate = Date.valueOf("2024-09-15");
//        Date invalidDate = Date.valueOf("2024-02-30"); // Invalid date
//        assertTrue(Data.dataValida(validDate), "Valid date should be considered valid.");
//        assertFalse(Data.dataValida(invalidDate), "Invalid date should be considered invalid.");
//    }*/
//
//    @Test
//    public void testDataValida() {
...
//        Date endDate = Date.valueOf("2024-09-15");
//        assertEquals(2, Data.distanzaInMesi(startDate, endDate), "Difference in months should be correct.");
//    }*/
//
//    @Test
//    public void testDistanzaInMesi() throws Exception {
...
//        Date date = Date.valueOf("2024-09-15");
//        Date expectedDate = Date.valueOf("2024-10-15");
//        Date actualDate = Data.quindiciMeseSucc(date);
//        assertEquals(expectedDate, actualDate, "Date 15th of next month should be correct.");
//    }*/
//
//    @Test
//    public void testQuindiciMeseSucc() {
