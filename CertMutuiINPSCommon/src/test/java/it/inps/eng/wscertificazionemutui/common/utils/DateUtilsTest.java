...
//        Date date = new Date();
//        XMLGregorianCalendar xmlCalendar = new DateUtils().toXMLGregorianCalendar(date);
//        assertNotNull(xmlCalendar, "XMLGregorianCalendar should not be null.");
//        assertEquals(date.getTime(), xmlCalendar.toGregorianCalendar().getTime().getTime(),
//                     "XMLGregorianCalendar should match the original date.");
//    }*/
//    
//    @Test
//    public void testToXMLGregorianCalendar() {
...
//        String currentDate = "202412";
//        String expected = "202501";
//        String actual = DateUtils.getAnnoMeseDataSucc(currentDate);
//        assertEquals(expected, actual, "The following month and year should be correct.");
//    }*/
//
//    @Test
//    public void testGetAnnoMeseDataSucc() {
...
//        String currentDate = "202401";
//        String expected = "202312";
//        String actual = DateUtils.getAnnoMeseDataPrec(currentDate);
//        assertEquals(expected, actual, "The previous month and year should be correct.");
//    }
//
//    @Test
//    public void testGetNomeMese() {
//        assertEquals("gennaio", DateUtils.getNomeMese(1), "The name of the month should be correct for January.");
//        assertEquals("febbraio", DateUtils.getNomeMese(2), "The name of the month should be correct for February.");
//        assertEquals("dicembre", DateUtils.getNomeMese(12), "The name of the month should be correct for December.");
//        assertNull(DateUtils.getNomeMese(13), "Should return null for an invalid month.");
//    }*/
//
//    @Test
//    public void testGetAnnoMeseDataPrec() {
